 ...
 */
public class Week2Adapter extends ArrayAdapter<Week> {
    ...
    public Week2Adapter(Activity activity, TwoWayView listView, int resource, ArrayList<Week> objects) {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
       ...
       // String teacher = Objects.requireNonNull(getItem(position)).getTeacher();
        ...
        week = new Week(subject, "null", room, time_from, time_to, color);
